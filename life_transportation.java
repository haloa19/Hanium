 ...
 */
public class life_transportation extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.life_transportation);
        ...
        CustomAdapter_life_transportation adapter= new CustomAdapter_life_transportation(getLayoutInflater());
